...
- [x] Added source-note support and published seven county introductions plus all 168 current municipalities across 166 profile cards from primary government or public-agency sources. The source audit found no hard link failures.
- [x] Connected those drafts to the production structured content with dated source notes, accessible expand controls, distinct matching for similarly named municipalities, and clearly labeled 2025 historical detail snapshots.
