...
- [ ] Owner reviews the displayed hours, business name, phone, description, and REALTOR® wording before any public edits are made. The owner confirmed that the former displayed address was a home address and authorized hiding it on July 27, 2026. Google Business Profile now records the business as having no customer-facing location. Ocean County was removed from the submitted service area on July 27, leaving the seven South Jersey counties; Google marked that service-area edit pending review. The site's licensed-office disclosure remains unchanged.
